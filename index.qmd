...
where, $\lambda$ = ratio of thermal conductivities of fluid to solid.
...
- <span style="font-size: 85%;">${\rm Ra} = 1{\rm E+}2$, ${\rm Pr} = 1$, $T_f = 40$</span>
- <span style="font-size: 85%;">$\ell_{\rm left} = 4$, $\ell_{\rm right} = 5$</span>
- <span style="font-size: 85%;">$\Delta t_{\rm coupling} = 0.1$</span>
